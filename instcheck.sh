...
wget -qO- bitbucket.org/nandoslayer/checkusers/downloads/chall.sh -O /bin/chall > /dev/null 2>&1
wget -qO- bitbucket.org/nandoslayer/checkusers/downloads/checkgestor.sh -O /bin/checkgestor > /dev/null 2>&1
wget -qO- bitbucket.org/nandoslayer/checkusers/downloads/checkgestor.py -O /usr/lib/checkgestor/checkgestor.py > /dev/null 2>&1
